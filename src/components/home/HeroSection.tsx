          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7">
              <h1 className="text-[1.65rem] sm:text-4xl md:text-5xl lg:text-[3.5rem] xl:text-[4rem] font-medium leading-[1.12] tracking-[-0.02em] mb-4 sm:mb-8 animate-fade-in-delay-1 text-center md:text-left text-white">
                Your teams waste hours on triage, data entry, and reporting.{" "}
              ...
              <p className="text-sm md:text-base text-white/50 leading-[1.6] max-w-sm md:max-w-md mb-8 md:mb-12 animate-fade-in-delay-2 text-center md:text-left mx-auto md:mx-0">
                Department-level AI systems, built and deployed inside your environment.
              </p>
