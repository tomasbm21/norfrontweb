        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="max-w-2xl mb-16">
            ...
            <p className="text-base text-muted-foreground leading-relaxed max-w-lg">
              We're building specialized AI companies for enterprise operations — nine vertical brands, production-proven systems, and local-market deployment. If you want to build real things that ship, we want to talk.
            </p>
          </div>
